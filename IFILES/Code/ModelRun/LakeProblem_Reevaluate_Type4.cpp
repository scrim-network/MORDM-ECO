/* LakeProblem_DeepUncertainty_Reevaluate_Type4Each.cpp
   
   Riddhi Singh, Feb, 2014
   The Pennsylvania State University
   rus197@psu.edu

   Reevlauating the solutions obtained by optimizing the 5 objective formulation with known uncertainty.
   This reevaluation is against the assumed known uncertainty, type 4 lognormal distribution. 
  ...
  Input Files
      1. SOWs_Type4.txt: the files containing SOWs against which the solutions are to be evaluated.
  ...
  Outputs
   ...
   Output Files
   1. LakeProblem_5ObjStochMM11AprilSelectedRSeed_Type4_Reev_Type4.txt
   The file contains the reevaluated objectives for the lognormal distribution. 
*/
  ...
  for (int rseed=0; rseed<nfiles; rseed++)
   {
     ...
     SOWfilename = path + SOWheader + "4" + ext;
     ...
     outfilename = path + outheader + outext  + "Type4" + ext;
