/* LakeProblem_1Obj_1Const_Stoch.cpp
   
   Riddhi Singh, Jan, 2014
   The Pennsylvania State University
   rus197@psu.edu

   Running BORG parallel for the stochastic lake model extended from Carpenter et al., 1999
...
int main(int argc, char* argv[]) 
{
  ...
  for (i=0; i<10; i++) {
    ...
    sprintf(runtime, "runtime1ObjBenStochMM_Type4_%d_%%d.txt", i);
